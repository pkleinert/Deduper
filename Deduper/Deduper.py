...
def deduplicate1(file_base, file_base_hashes, file_child, file_child_hashes, file_diff_ids, file_diff_data, print_progress = False):
	...
	print('Hashing: base...')
	hashes_base = hash_from_file(file_base_hashes, print_progress)

	# Get block hashes of child file
	print('Hashing: child...')
	hashes_child = hash_from_file(file_child_hashes, print_progress)
...
if __name__ == '__main__':
	...
	file_base		= 'c:\\Temp\\DeDupTests\\01\\20181017-Disk-0.vhdx'
	file_child		= 'c:\\Temp\\DeDupTests\\01\\20181019-Disk-0.vhdx'
	file_restore	= 'c:\\Temp\\DeDupTests\\01\\20181019-Disk-0-restored.vhdx'
	file_diff_ids	= 'c:\\Temp\\DeDupTests\\01\\20181017-20181019.dfb'
	file_diff_data	= 'c:\\Temp\\DeDupTests\\01\\20181017-20181019.dfd'
	...
	print("\nRestoring...")
	restore(file_base, file_restore, file_diff_ids, file_diff_data, True)

	if (len(sys.argv) == 1 and True==False):

		file_base			= "C:\\Temp\\DeDupTests\\01\\20181017-Disk-0.vhdx"
		file_base_hashes	= "C:\\Temp\\DeDupTests\\01\\20181017.blk"
		file_child			= "C:\\Temp\\DeDupTests\\01\\20181018-Disk-0.vhdx"
		file_child_hashes	= "C:\\Temp\\DeDupTests\\01\\20181018.blk"
		file_diff_ids		= "C:\\Temp\\DeDupTests\\01\\20181017-20181018.dfb"
		file_diff_data		= "C:\\Temp\\DeDupTests\\01\\20181017-20181018.dfd"

		blocks = deduplicate(file_base, file_base_hashes, file_child, file_child_hashes, file_diff_ids, file_diff_data)
		...
		file_base			= "C:\\Temp\\DeDupTests\\01\\20181017-Disk-0.vhdx"
		file_child			= "C:\\Temp\\DeDupTests\\01\\20181018-Disk-0-restored.vhdx"
		file_diff_ids		= "C:\\Temp\\DeDupTests\\01\\20181017-20181018.dfb"
		file_diff_data		= "C:\\Temp\\DeDupTests\\01\\20181017-20181018.dfd"

		restore(file_base, file_child, file_diff_ids, file_diff_data)
	...
	elif (len(sys.argv) == 6 and (sys.argv[1] == "--dedup" or sys.argv[1] == "-dedup") ):
		file_base		= sys.argv[2]
		file_child		= sys.argv[3]
		file_diff_ids	= sys.argv[4]
		file_diff_data	= sys.argv[5]

		blocks = deduplicate2(file_base, file_child, file_diff_ids, file_diff_data)
	...
	elif (len(sys.argv) == 8 and (sys.argv[1] == "--dedup" or sys.argv[1] == "-dedup") ):
		file_base  = sys.argv[2]
	...
	print("\nDone in ", time.time() - start_time, " second(s)")
